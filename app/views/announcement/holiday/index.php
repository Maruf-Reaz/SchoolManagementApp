                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="filters">
                                    ...
                                    <a data-toggle="tooltip" onClick="window.print()" title="Print" class="fa fa-print"
                                       href="#"
                                       style="float: right;padding-top: 8px;padding-right: 15px;font-size: 30px "></a>
                                    <a data-toggle="tooltip" title="Add Holiday" class="fa fa-plus"
                                       href="<?php echo URLROOT; ?>/announcement/Holidays/add"
                                       style="float: right;padding-top: 8px;padding-right: 15px;font-size: 30px "></a>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped jambo_table bulk_action">
                                            ...
                                            <tr class="headings">
                                                ...
                                                <th class="column-titlet">From Date</th>
                                                <th class="column-titlet">To Date</th>
                                                <th class="column-titlet">Details</th>
											...
											foreach ( $data['holidays'] as $holiday ): ?>
                                                ...
                                                <tr class="even pointer">
                                                    ...
                                                    <td><?php echo $holiday->to_date ?></td>
                                                    <td colspan="0.5"><?php echo $holiday->details ?></td>
                                                    <td>
                                                        ...
                                                        <div data-toggle="tooltip" title="View Options"
                                                            ...
                                                            <ul class="dropdown-menu pull-right" role="menu"
                                                                ...
                                                                <li><a data-toggle="tooltip" title="Edit"
                                                                       href="<?php echo URLROOT ?>/announcement/Holidays/show/<?php echo $holiday->id; ?>"><i
                                                                                class="fa fa-edit fa-lg"></i> Edit</a>
                                                                </li>
                                                                <li><a data-toggle="tooltip" title="Delete"
                                                                       href="<?php echo URLROOT ?>/announcement/Holidays/delete/<?php echo $holiday->id; ?>"
