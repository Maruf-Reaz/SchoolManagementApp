                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="au-card-title">
                                    ...
                                    <h3>
                                        <i class="fa fa-pencil-alt"></i>Deactivate Teacher</h3>
                                </div>
                                <div class="card-body">

                                    <form action="<?php URLROOT ?>/Teachers/deactivateTeacher/<?php echo $data['teacher']->id ?>"
                                          method="post">
                                        <div class="form-group">
                                            <div class="input-group-addon2">Deactivation Date</div>
                                            <div class="input-group">
                                                <input <input
                                                        placeholder="<?php echo date("m") ?>/<?php echo date("d") ?>/<?php echo date("Y") ?>"
                                                        type="text"
                                                        name="deactivation_date" value=""
