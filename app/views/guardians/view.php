            ...
            <div class="row" style="margin-top: 72px;">
                <div class="col-md-3">
                    <div style="padding-bottom: 9px;padding-top: 1px; background-image:url('<?php echo URLROOT; ?>/images/bg-title-01.jpg');"
                        ...
                        <h3><i class="fa fa-pencil-alt"></i>Parent Profile</h3>
                    </div>
                    <center style="padding-top: 18px; background: #fff; height: 282px; border-bottom-right-radius: 10px; border-bottom-left-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.11);">
                        <a href="#">
                            <img src="<?php URLROOT; ?>/images/guardians/<?php echo $data['guardian']->photo; ?>"
                                 alt="image" class="img-circle" style="width: 60%; height: 150px;"/>
                        </a>
                        <br>
                        <h3>
							<?php echo $data['guardian']->guardian_name; ?>
                        </h3>
						<?php echo $data['guardian']->registration_no; ?>
                    </center>
                </div>
                <div class="col-md-9">
                        ...
                        <div class="tab-pane active" id="tab1">
                            <table class="table table-bordered" style="margin-top: 20px;">
                                ...
                                <tr>
                                    ...
                                    <td>
										<?php echo $data['guardian']->nid_number; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%">
                                    ...
                                    <td>
										<?php echo $data['guardian']->contact_number; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%">
                                ...
                                <tr>
                                    ...
                                    <td>
										<?php echo $data['guardian']->occupation; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%">
                                ...
                                <tr>
                                    ...
                                    <td>
										<?php echo $data['guardian']->blood_group; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%">
                                    ...
                                    <td>
										<?php echo $data['guardian']->present_address; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%">
                                    ...
                                    <td>
										<?php echo $data['guardian']->permanent_address; ?>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
