                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="au-card-title"
                                    ...
                                    <h3>
                                        <i class="fa fa-pencil-alt"></i>Edit Device User</h3>
                                </div>
                                <div class="card-body">
                                    <form action="<?php URLROOT ?>/attendance/time-attendance-users/update-user"
                                          enctype="multipart/form-data"
                                          method="post" id="register-form">
                                        <input type="hidden" value="<?php echo $data['user']->registration_no; ?>" name="registration_no">

                                        <div class="form-group">
                                            <div class="input-group-addon2">Registration Number (Not editable)</div>
                                            <div class="input-group">
                                                <input type="text" id="registration_no"  disabled
                                                       value="<?php echo $data['user']->registration_no; ?>"
                                                       class="form-control col-md-6" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="input-group-addon2">PIN (Not editable)</div>
                                            <div class="input-group">
                                                <input type="text" id="registration_no"  disabled
                                                       value="<?php echo $data['user']->pin2; ?>"
                                                       class="form-control col-md-6" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group-addon2">Card Number *</div>
                                            <div class="input-group">
                                                <input type="text" id="card" name="card"
                                                       value="<?php echo $data['user']->card; ?>"
                                                       class="form-control col-md-6" required>
                                            </div>
                                        </div>
                                        <!--Hidden Group-->
                                        ...
                                        <div class="form-actions form-group">
                                            <button type="submit" class="btn btn-primary">Update Device User</button>
                                        </div>
