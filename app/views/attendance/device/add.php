                    ...
                    <div class="x_panel au-card au-card au-card--no-pad m-b-40">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="card-body">
                                    <form action="<?php echo URLROOT; ?>/attendance/time-attendance-devices/store"
                                          method="post" id="register-form">
                                        <div class="form-group">
                                            <div class="input-group-addon2">Ip Address *</div>
                                            <div class="input-group">
                                                <input type="text" name="ip" placeholder="198.168.0.1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="internal_id" value='1'
                                                       class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="com_key" value="0"
                                                       class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="device_name" placeholder="ZKTeco F18"
                                                       class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="description" value="N/A"
                                                       class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="soap_port" value="80"
                                                       class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="encoding" value="iso8859-1"
                                                       class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <label class="radiobutton">Active <input type="radio" name="status"
                                                                                         value="1" required><span
                                                            class="radiocheckmark"></span></label>
                                                <label class="radiobutton">Deactive <input type="radio" name="status"
