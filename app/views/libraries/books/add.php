				...
				<div class="col-lg-6">
					<div class="card">
						...
						<div class="card-body card-block">
							<form action="<?php URLROOT; ?>/libraries/books/add" method="post" class="form-horizontal">
								...
								<div class="row form-group">
									...
									<div class="col-12 col-md-9">
										<input type="text" id="author" name="author"
										       placeholder="Enter Author Name..." class="form-control" required>
									</div>
								</div>
								<div class="row form-group">
									<div class="col col-md-3">
									...
									<div class="col-12 col-md-9">
										<input type="text" id="subject_code" name="subject_code"
										       placeholder="Enter Subject Code..." class="form-control" required>
									</div>
								</div>
								<div class="row form-group">
									<div class="col col-md-3">
								...
								<div class="row form-group">
									...
									<div class="col-12 col-md-9">
										<input type="number" id="rack_number" name="rack_number"
										       placeholder="Enter Rack Number..." class="form-control" required>
									</div>
								</div>
