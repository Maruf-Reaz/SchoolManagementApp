                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <strong>Edit Routines</strong>
                        </div>
                        <div class="card-body card-block">
                            <form action="<?php echo URLROOT; ?>/academic/routines/update" method="post"
                                  enctype="multipart/form-data"
                                  class="form-horizontal">
                                <input type="hidden" value="<?php echo $data['routine']->id; ?>" name="id">
                                <!--School Year-->
                                        ...
                                        <div class="col-md-8">
                                            <div class="card border border-danger">
                                                <div class="card-header danger-color">
                                                    <strong class="card-title text-danger">Conflicted Routine</strong>
                                                </div>
                                                <div class="card-body">
                                                    <table class="table">
                                                        <tr>
