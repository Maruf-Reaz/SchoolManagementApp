                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="au-card-title"
                                    ...
                                    <h3><i class="fa fa-pencil-alt"></i>Expenses</h3>
                                </div>
                                <div class="filters">
                                    ...
                                    <a data-toggle="tooltip" onClick="window.print()" title="Print" class="fa fa-print"
                                       href="#"
                                       style="float: right;padding-top: 8px;padding-right: 15px;font-size: 30px "></a>
                                    <a data-toggle="tooltip" title="Add Expense" class="fa fa-plus"
                                       href="<?php URLROOT; ?>/accounts/expenses/add"
											...
											<?php if ( $data['expenses'] != null ): ?>
												<?php foreach ( $data['expenses'] as $key => $expense ): ?>
                                                    <tr class="even pointer">
                                                        ...
                                                        <td><?php echo $expense->expense_type_name; ?></td>
                                                        <td><?php echo $expense->date; ?></td>
                                                        <td><?php echo $expense->accountant_name; ?></td>
                                                        ...
                                                        <!--<td>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu pull-right" role="menu"
                                                                    ...
                                                                    <li>
                                                                        <a href="<?php /*URLROOT; */ ?>/accounts/expenses/edit/<?php /*echo $expense->id */ ?>"><i
                                                                    ...
                                                                    <li>
                                                                        <a class="delete-confirm"
                                                                           ...
                                                                           href="<?php /*URLROOT; */ ?>/accounts/expenses/delete/<?php /*echo $expense->id */ ?>">
