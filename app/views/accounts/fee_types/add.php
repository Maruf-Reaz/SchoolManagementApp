                ...
                <div class="col-lg-6" style="margin: auto">
                    <div class="au-card au-card au-card--no-pad m-b-40">
                        <div class="au-card-title"
                            ...
                            <h3>
                                <i class="fa fa-pencil-alt"></i>Add A Fee Type</h3>
                        </div>
                        <div class="card-body card-block">
                            <form action="<?php URLROOT; ?>/accounts/feetypes/add" method="post"
                                  class="form-horizontal">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon">Name</div>
                                        <input type="text" id="fee_type_name" name="fee_type_name"
                                               placeholder="Enter Type Of Fee..." class="form-control" required>
