                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="au-card-title"
                                    ...
                                    <h3><i class="fa fa-pencil-alt"></i>Expense Types</h3>
                                </div>
                                <div class="filters">
                                    ...
                                    <a data-toggle="tooltip" onClick="window.print()" title="Print" class="fa fa-print"
                                       href="#"
                                       style="float: right;padding-top: 8px;padding-right: 15px;font-size: 30px "></a>
                                    <a data-toggle="tooltip" title="Add Expense Type" class="fa fa-plus"
                                       href="<?php URLROOT; ?>/accounts/expensetypes/add"
                                ...
                                <div class="x_content">
                                    <div class="table-responsive">
                                        <table class="table table-striped jambo_table bulk_action">
                                            ...
                                            <tbody>
											<?php if ( $data['expense_types'] != null ): ?>
												<?php foreach ( $data['expense_types'] as $key => $expense_type ): ?>
                                                    <tr class="even pointer">
                                                        <td><?php echo $key += 1; ?></td>
                                                        <td><?php echo $expense_type->expense_type_name ?></td>
                                                        <td><?php echo $expense_type->note ?></td>
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu pull-right" role="menu"
                                                                    ...
                                                                    <li>
                                                                        <a href="<?php URLROOT; ?>/accounts/expensetypes/edit/<?php echo $expense_type->id ?>"><i
                                                                                    class="fa fa-edit fa-lg"></i>
                                                                            Edit</a>
                                                                    </li>
                                                                    <li>
                                                                        <a class="delete-confirm" data-title="Delete Confirmation!" href="<?php URLROOT; ?>/accounts/expensetypes/delete/<?php echo $expense_type->id ?>">
