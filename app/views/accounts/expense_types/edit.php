                ...
                <div class="col-lg-6" style="margin: auto">
                    <div class="au-card au-card au-card--no-pad m-b-40">
                        <div class="au-card-title"
                            ...
                            <h3>
                                <i class="fa fa-pencil-alt"></i>Edit Type Of Expense</h3>
                        </div>
                        <div class="card-body card-block">
                            <form action="<?php URLROOT; ?>/accounts/expensetypes/edit" method="post"
                                  class="form-horizontal">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon">Name</div>
                                        <input type="hidden" id="id" name="id"
                                               value="<?php echo $data['expense_type']->id ?>">
                                        <input type="text" id="expense_type_name" name="expense_type_name"
                                               placeholder="Edit Type Of Expense..."
                                               value="<?php echo $data['expense_type']->expense_type_name ?>"
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="note" name="note"
                                               value="<?php echo $data['expense_type']->note ?>"
