                ...
                <div class="col-lg-6" style="margin: auto">
                    <div class="au-card au-card au-card--no-pad m-b-40">
                        <div class="au-card-title"
                            ...
                            <h3>
                                <i class="fa fa-pencil-alt"></i>Add Type of Income</h3>
                        </div>
                        <div class="card-body card-block">
                            <form action="<?php URLROOT; ?>/accounts/incometypes/add" method="post"
                                  class="form-horizontal">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon">Name</div>
                                        <input type="text" id="income_type_name" name="income_type_name"
                                               placeholder="Enter Type Of Income..." class="form-control" required>
