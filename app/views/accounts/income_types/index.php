                    ...
                    <div class="au-card au-card au-card--no-pad m-b-40">
                            <div class="col-md-12 col-sm-12 col-xs-12 no-padding-left-right">
                                <div class="au-card-title"
                                    ...
                                    <h3><i class="fa fa-pencil-alt"></i>Income Types</h3>
                                </div>
                                <div class="filters">
                                    ...
                                    <a data-toggle="tooltip" onClick="window.print()" title="Print" class="fa fa-print"
                                       href="#"
                                       style="float: right;padding-top: 8px;padding-right: 15px;font-size: 30px "></a>
                                    <a data-toggle="tooltip" title="Add Income Type" class="fa fa-plus"
                                       href="<?php URLROOT; ?>/accounts/incometypes/add"
                                ...
                                <div class="x_content">
                                    <div class="table-responsive">
                                        <table class="table table-striped jambo_table bulk_action">
                                            ...
                                            <tbody>
											<?php if ( $data['income_types'] != null ): ?>
												<?php foreach ( $data['income_types'] as $key => $income_type ): ?>
                                                    <tr class="even pointer">
                                                        <td><?php echo $key += 1; ?></td>
                                                        <td><?php echo $income_type->income_type_name ?></td>
                                                        <td><?php echo $income_type->note ?></td>
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu pull-right" role="menu"
                                                                    ...
                                                                    <li>
                                                                        <a href="<?php URLROOT; ?>/accounts/incometypes/edit/<?php echo $income_type->id ?>"><i
                                                                    ...
                                                                    <li>
                                                                        <a class="delete-confirm"
                                                                           ...
                                                                           href="<?php URLROOT; ?>/accounts/incometypes/delete/<?php echo $income_type->id ?>">
