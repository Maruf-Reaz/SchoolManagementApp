                    ...
                    <div class="x_panel au-card au-card au-card--no-pad m-b-40">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="card-body">
                                    <form action="<?php URLROOT ?>/exam/Grades/editGrade" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="grade_name"
                                                       value="<?php echo $data['grade_name'] ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="grade_point"
                                                       value="<?php echo $data['grade_point'] ?> " class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="mark_from"
                                                       value="<?php echo $data['mark_from'] ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="mark_upto"
                                                       value="<?php echo $data['mark_upto'] ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="note"
                                                       value="<?php echo $data['note'] ?>"  class="form-control">
                                            </div>
                                        </div>
